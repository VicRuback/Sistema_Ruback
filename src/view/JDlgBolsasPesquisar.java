...
public class JDlgBolsasPesquisar extends javax.swing.JDialog {
    ...
    public JDlgBolsasPesquisar(java.awt.Frame parent, boolean modal) {
        ...
        controllerBolsas = new ControllerBolsas();
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgBolsasPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgBolsasPesquisar dialog = new JDlgBolsasPesquisar(new javax.swing.JFrame(), true);
