...
public class JDlgVendasProdutos extends javax.swing.JDialog {
    ...
    public JDlgVendasProdutos(java.awt.Frame parent, boolean modal) {
     ...
     public void setTelaAnterior(JDlgVendas jDlgVendas, VarVendasBolsas varVendasBolsas){
    this.jDlgVendas = jDlgVendas;
     incluir = true;
        if(varVendasBolsas != null){
        incluir = false;
        jCboProdutos.setSelectedItem(varVendasBolsas.getVarBolsas());
        jTxtQuantidade.setText(Util.intToStr(varVendasBolsas.getVarQuantidade()));
        }
    ...
    private void initComponents() {
        ...
        jCboProdutos = new javax.swing.JComboBox<VarBolsas>();
    ...
    private void jCboProdutosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCboProdutosActionPerformed
        ...
        jTxtValorUnitario.setText(Util.doubleToStr(varBolsas.getVarPreco()));
    ...
    private javax.swing.JComboBox<VarBolsas> jCboProdutos;
